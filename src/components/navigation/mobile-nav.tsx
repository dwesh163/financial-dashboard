...
export const MobileNav = () => {
  ...
  return (
    <div className="mobile-nav fixed bottom-0 left-0 right-0 z-50 md:hidden border-t border-border bg-card/95 backdrop-blur-md pb-[env(safe-area-inset-bottom)]">
