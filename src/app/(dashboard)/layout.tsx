...
export default async function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="dark min-h-screen flex bg-background">
      ...
      <main className="flex-1 px-4 pt-[calc(1rem_+_env(safe-area-inset-top))] pb-[calc(5rem_+_env(safe-area-inset-bottom))] md:px-8 md:py-8 md:pb-8 overflow-auto min-w-0 md:ml-56">
        {children}
      </main>
      <MobileNav />
    </div>
